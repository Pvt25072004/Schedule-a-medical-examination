...
import { Calendar, Clock, User, FileText, CheckCircle, Search, Star, Award, ArrowLeft, ArrowRight, MapPin } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {step === 2 && (
          <div className="space-y-6">
            <Card>
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Chọn ngày và giờ khám</h2>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                  {TIME_SLOTS.map((slot) => {
                    const available = formData.date ? isSlotAvailable(formData.doctorId, formData.date, slot.time) : true;
                    return (
                      <button
                        key={slot.time}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3 p-3 bg-white rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900">STL Clinic</p>
                        <p className="text-sm text-gray-600">123 Đường ABC, Q.1, TP.HCM</p>
                      </div>
                    </div>
                  </div>
                </div>
