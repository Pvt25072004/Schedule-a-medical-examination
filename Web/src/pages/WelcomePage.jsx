...
const WelcomePage = ({ navigate }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50 to-white">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-10">
              ...
              <p className="text-xl text-gray-500 leading-relaxed max-w-lg">
                Kết nối với hàng trăm bác sĩ chuyên khoa hàng đầu. Đặt lịch khám
                chỉ với 30 giây, mọi lúc mọi nơi.
              </p>
            ...
            <div className="relative lg:h-[600px] flex items-center justify-center mt-10 lg:mt-0">
              ...
              <div className="relative w-full h-[400px] sm:h-[500px] lg:h-[90%] max-w-md mx-auto z-10">
                ...
                {/* Floating Cards */}
                <div
                  className="absolute -left-4 sm:-left-12 top-20 animate-bounce"
                ...
                >
                  <div className="bg-white/90 backdrop-blur-md p-4 rounded-2xl shadow-2xl border border-white flex items-center gap-4">
                    ...
                    <div>
                      <div className="font-bold text-[#143250] sm:text-lg">
                        An toàn
                      </div>
                ...
                <div
                  className="absolute -right-4 sm:-right-12 bottom-20 sm:bottom-32 animate-bounce"
        ...
        >
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-500 max-w-2xl mx-auto">
              Chúng tôi cam kết mang đến trải nghiệm y tế trực tuyến tiện lợi,
              an toàn và chuyên nghiệp nhất.
            </p>
          </div>
              ...
              return (
                <div
                  ...
                  onClick={() => {
                    if (feature.title === "Đặt lịch Online") {
                      ...
                      feature.title === "Tư vấn Online" ||
                      feature.title === "Tư vấn trực tuyến"
                    ) {
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div
                      className={`w-20 h-20 mx-auto bg-${feature.color}-50 rounded-[1.5rem] flex items-center justify-center mb-8 transform group-hover:scale-110 transition-transform duration-500 shadow-sm`}
                    >
                      <feature.icon
                        className={`w-10 h-10 text-${feature.color}-500`}
                      />
                    </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
              <div>
                ...
                <p className="text-xl text-gray-500 max-w-2xl">
                  Những ưu đãi và sự kiện mới nhất từ hệ thống STL Clinic
                </p>
              </div>
              <div className="flex gap-4">
                <button
                  onClick={() =>
                    setCurrentBannerIdx(Math.max(0, currentBannerIdx - 1))
                  }
            ...
            <div className="overflow-hidden -mx-4 px-4 py-4">
              <div
                ...
                style={{
                  transform: `translateX(-${currentBannerIdx * (100 / 3)}%)`,
                }}
              >
                {banners.map((banner) => (
                  <div
                    ...
                    onClick={() => {
                      if (banner.doctor_id)
                        requireAuthAndNavigate(PAGES.BOOK_DOCTOR, {
                          state: { doctorId: banner.doctor_id },
                        });
                      else if (banner.hospital_id)
                        navigate(`/fanpage/${banner.hospital_id}`);
                  ...
                  >
                    <div className="relative rounded-[2rem] overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.12)] transition-all duration-500 h-[260px] transform hover:-translate-y-2">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-[#143250]/90 via-[#143250]/40 to-transparent flex flex-col justify-end p-6">
                        ...
                        <h3 className="text-white font-bold text-xl mb-2 leading-tight group-hover:text-[#48a1f3] transition-colors">
                          {banner.title}
                        </h3>
                        {banner.description && (
            ...
            {banners.length > 3 && (
              <div className="flex justify-center mt-10 gap-2">
                {Array.from({ length: Math.max(1, banners.length - 2) }).map(
                  (_, idx) => (
                    <button
                      key={idx}
      ...
      <section
        id="doctors"
        className="py-24 bg-[#f8fbff] relative overflow-hidden"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div>
              ...
              <p className="text-xl text-gray-500 max-w-2xl">
                Các chuyên gia y tế giàu kinh nghiệm, tận tâm với nghề, luôn sẵn
                sàng chăm sóc sức khoẻ của bạn.
              </p>
            </div>
            <button
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-[#143250]/90 via-[#143250]/40 to-transparent flex flex-col justify-center p-8 md:p-16">
                      <div className="max-w-2xl transform translate-y-4 group-hover:translate-y-0 transition-transform duration-700">
                        ...
                        <h3 className="text-white font-black text-3xl md:text-5xl mb-4 leading-tight drop-shadow-md">
                          {banner.title}
                        </h3>
                        {banner.description && (
                          <p className="text-blue-50 text-sm md:text-lg max-w-xl opacity-90 drop-shadow line-clamp-2 md:line-clamp-3">
                            {banner.description}
                          </p>
                        )}
                      </div>
        ...
        <section className="py-24 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <p className="text-xl text-blue-100/80 mb-10 max-w-2xl mx-auto leading-relaxed">
              Tạo tài khoản miễn phí ngay hôm nay để trải nghiệm dịch vụ y tế
              thông minh, tiện lợi và tiết kiệm thời gian nhất.
            </p>
                  ...
                  {selectedPackage.fixed_price && (
                    <div className="flex flex-col border-l border-gray-200 pl-6">
                      ...
                      <div className="font-black text-[#f99b1c] text-xl">
                        {Number(selectedPackage.fixed_price).toLocaleString(
                          "vi-VN",
                        )}
                        đ
                      </div>
