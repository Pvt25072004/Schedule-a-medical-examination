              ...
              showDialog(
                ...
                builder: (BuildContext verifyContext) {
                  ...
                  return StatefulBuilder(builder: (context, setVerifyState) {
                    return AlertDialog(
                      title: const Text('Xác nhận Thanh toán', style: TextStyle(color: Color(0xFF48A1F3))),
                      content: Column(
                      ...
                      actions: [
                        ...
                        ElevatedButton(
                          style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF48A1F3), foregroundColor: Colors.white),
