...
class FanpageDetailScreen extends StatefulWidget {
  ...
  const FanpageDetailScreen({super.key, required this.fanpageId});
...
class _FanpageDetailScreenState extends State<FanpageDetailScreen> {
  ...
  Widget build(BuildContext context) {
    if (_isLoading) {
      return Scaffold(
        appBar: AppBar(backgroundColor: const Color(0xFF48A1F3), foregroundColor: Colors.white, title: const Text('Chi tiết Fanpage')),
                      ...
                      Row(
                        children: [
                          ...
                          if (followerCount >= 100000)
                            const Icon(Icons.verified, color: Color(0xFF48A1F3), size: 20),
                        ],
                      ),
