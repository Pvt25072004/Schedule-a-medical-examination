                    ...
                    return GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: isSelected ? primaryColor : (isToday && !isDisabled ? primaryColor.withOpacity(0.1) : Colors.transparent),
                          border: isSelected ? Border.all(color: primaryDarkColor, width: 2) : (isToday ? Border.all(color: primaryColor) : null),
                        ),
                        child: Center(
                    ...
                    return GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: isSelected ? primaryDarkColor : Colors.grey.shade300),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(Icons.check_circle_outline, color: primaryColor, size: 28),
            ),
