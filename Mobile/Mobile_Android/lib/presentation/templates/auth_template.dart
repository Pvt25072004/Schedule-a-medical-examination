    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          const Positioned.fill(child: _AnimatedBackgroundBalls()),
...
class _AnimatedBackgroundBalls extends StatefulWidget {
  const _AnimatedBackgroundBalls();

  @override
  State<_AnimatedBackgroundBalls> createState() => _AnimatedBackgroundBallsState();
}

class _AnimatedBackgroundBallsState extends State<_AnimatedBackgroundBalls> with TickerProviderStateMixin {
  ...
  @override
  Widget build(BuildContext context) {
    // Return the positioned balls in a Stack that fills the constraints
    return Stack(
      children: [
