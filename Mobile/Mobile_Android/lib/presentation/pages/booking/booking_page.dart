...
import '../../organisms/booking/booking_process_bar.dart';
import 'package:clinic_booking_system/core/tokens/app_colors.dart';

import '../../organisms/booking/step1_area_selection.dart';
import 'package:clinic_booking_system/core/tokens/app_colors.dart';

import '../../organisms/booking/step2_hospital_selection.dart';
import 'package:clinic_booking_system/core/tokens/app_colors.dart';

import '../../organisms/booking/step3_specialty_selection.dart';
import 'package:clinic_booking_system/core/tokens/app_colors.dart';

import '../../organisms/booking/step4_date_time_selection.dart';
import 'package:clinic_booking_system/core/tokens/app_colors.dart';

import '../../organisms/booking/step5_doctor_selection.dart'; // step5_doctor_selection
import '../../organisms/booking/step6_patient_info.dart'; // step6_patient_info
import '../../organisms/booking/step7_payment.dart'; // step7_payment
import '../../organisms/booking/step8_confirmation.dart'; // step8_confirmation

class BookingPage extends StatefulWidget {
  final Map<String, dynamic>? initialDoctorData;
  final Map<String, dynamic>? initialPackageData;

  const BookingPage({super.key, this.initialDoctorData, this.initialPackageData});
...
class _BookingPageState extends State<BookingPage> {
  ...
  Color specialtyColor = AppColors.primary;
    ...
    setState(() {
      ...
      if (data != null) {
        if (step == 2) {
          ...
          specialtyColor = data['color'] ?? AppColors.primary;
        } else if (step == 5) {
