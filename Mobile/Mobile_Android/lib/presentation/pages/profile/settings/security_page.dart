...
import '../../../../presentation/pages/auth/password/reset_pass_page.dart';
import '../../../../presentation/pages/auth/password/create_and_reset_pin_page.dart';
  ...
  Widget _buildPinCard() {
    return _buildMenuCard(
      ...
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => const CreateAndResetPinPage()),
        );
      },
    );
  }
