...
class Step8Confirmation extends StatelessWidget {
  ...
  final Color successColor = AppColors.primary;
  ...
  Widget _buildInfoItem(IconData icon, String label, String value, {bool isHeader = false}) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Icon(icon, size: 20, color: isHeader ? AppColors.primaryDark : Colors.grey),
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: isHeader ? AppColors.primaryDark : Colors.black87,
                  ),
                ),
              ],
            ),
  ...
  Widget _buildListItem(String text) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Icon(Icons.circle, size: 8, color: AppColors.primaryDark.withOpacity(0.7)),
          const SizedBox(width: 8),
          Expanded(child: Text(text, style: TextStyle(color: AppColors.primaryDark.withOpacity(0.8)))),
        ],
      ),
    );
  }
