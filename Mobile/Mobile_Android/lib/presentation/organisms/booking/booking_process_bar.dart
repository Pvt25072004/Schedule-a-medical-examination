...
class _BookingProgressBarState extends State<BookingProgressBar> {
  ...
  Widget build(BuildContext context) {
    ...
    const Color activeColor = AppColors.accent; // Cam accent
        ...
        child: Row(
          ...
          children: List.generate(widget.totalSteps, (index) {
            ...
            final Widget divider = stepNum < widget.totalSteps
              ...
              height: 2,
              color: isCompleted
                  ? AppColors.primary : Colors.grey.withOpacity(0.3),
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: isActive
                          ? activeColor
                          : (isCompleted ? AppColors.primary : Colors.grey.withOpacity(0.3)),
                      border: Border.all(
                          color: isActive ? activeColor : (isCompleted ? AppColors.primary : Colors.grey.shade400),
                          width: 2
                      ),
                    ),
                    child: Center(
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color: isActive ? activeColor : (isCompleted ? AppColors.primaryDark : Colors.grey),
                    ),
