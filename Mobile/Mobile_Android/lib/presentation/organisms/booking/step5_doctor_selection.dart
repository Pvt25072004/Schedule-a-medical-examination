                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Wrap(
                                  ...
                                  children: [
                                    Chip(
                                      label: Text('$expYears năm kinh nghiệm', style: TextStyle(fontSize: 12, color: AppColors.primaryDark)),
                                    ...
                                    Chip(
                                      label: Text('Sẵn sàng', style: TextStyle(fontSize: 12, color: AppColors.primary)),
                                      backgroundColor: AppColors.primaryLight,
                                      avatar: Icon(Icons.check_circle, size: 16, color: AppColors.primary),
                                      materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
                                    ),
                                  ],
                                ),
